 ...
     <div class="zhong" :class="{ 'hidden': isHidden }">
    <div class="zhong-content">
      ...
      <div class='duihuaxuanze' 
        ...
        <button class="setting-btn" v-if="selectedDialogIndex.today === index" @click.stop="handleSettingClick('today', index)">设置</button>
        <div v-if="dialogSettings.today[index]" class="dialog-settings">
          <button @click="editDialog('today', index)">编辑</button>
          <button @click="toggleSelectDialog('today', index)">多选</button>
          <button @click="deleteDialog('today', index)">删除</button>
        </div>
      </div>
      ...
      <div class='duihuaxuanze' 
        ...
        <div class="dialog-text">{{ dialog }}</div>
        <button class="setting-btn" v-if="selectedDialogIndex.weekly === index" @click.stop="handleSettingClick('weekly', index)">设置</button>
        <div v-if="dialogSettings.weekly[index]" class="dialog-settings">
          <button @click="editDialog('weekly', index)">编辑</button>
          <button @click="toggleSelectDialog('today', index)">多选</button>
          <button @click="deleteDialog('weekly', index)">删除</button>
      ...
      <div class='duihuaxuanze' 
        ...
        <div class="dialog-text">{{ dialog }}</div>
        <button class="setting-btn" v-if="selectedDialogIndex.monthly === index" @click.stop="handleSettingClick('monthly', index)">设置</button>
        <div v-if="dialogSettings.monthly[index]" class="dialog-settings">
          <button @click="editDialog('monthly', index)">编辑</button>
          <button @click="toggleSelectDialog('today', index)">多选</button>
          <button @click="deleteDialog('monthly', index)">删除</button>
      ...
      <div class='duihuaxuanze' 
        ...
        <div class="dialog-text">{{ dialog }}</div>
        <button class="setting-btn" v-if="selectedDialogIndex.earlier === index" @click.stop="handleSettingClick('earlier', index)">设置</button>
        <div v-if="dialogSettings.earlier[index]" class="dialog-settings">
          <button @click="editDialog('earlier', index)">编辑</button>
          <button @click="toggleSelectDialog('earlier', index)">多选</button>
          <button @click="deleteDialog('earlier', index)">删除</button>
